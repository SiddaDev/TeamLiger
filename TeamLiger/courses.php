...
<body>
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Courses</h2>
        <p>A professional course is a learning experience that empowers you with the skills that are needed to perform a task or tasks that are specific to your career. A professional course is a very specific and practical training meant for working professionals. A good course, chosen with care, can improve your performance and give your career a big push. It is flexible, low cost and tailor-made for busy professionals. </p>
      </div>
    </div><!-- End Breadcrumbs -->
            ...
            <div class="course-item">
              ...
              <div class="course-content">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  ...
                  <p class="price">Rs.<?php echo $course['price'];?></p>
                </div>

                <h3><a href="course-details.html"><?php echo $course['Topic'];?></a></h3>
                <p><?php echo $course['Description'];?></p>
                <div class="trainer d-flex justify-content-between align-items-center">
                  <div class="trainer-profile d-flex align-items-center">
                    <img src="assets/img/trainers/trainer-1.jpg" class="img-fluid" alt="">
                    <span><?php echo $course['trainer'];?></span>
                  </div>
                  <div class="trainer-rank d-flex align-items-center">
                    <i class="bx bx-user"></i>&nbsp;<?php echo $course['Enrollments'];?>
                    &nbsp;&nbsp;
